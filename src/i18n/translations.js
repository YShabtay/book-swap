export const translations = {
  en: {
    ...
    statusUnavailable: 'No Longer Available',
    ...
    outgoingStatusUnavailable: 'Book no longer available',
    openChat: 'Open Chat',
  ...
  he: {
    ...
    statusUnavailable: 'לא זמין יותר',
    ...
    outgoingStatusUnavailable: 'הספר נתפס',
    openChat: 'פתח צ\'אט',
    withPerson: 'עם {{name}}',
    fromPerson: 'מאת {{name}}',
