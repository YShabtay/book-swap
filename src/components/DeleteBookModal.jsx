  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3 p-5 pt-1 sm:flex-row sm:justify-end">
          <button
            type="button"
            onClick={onCancel}
          ...
          <button
            type="button"
            onClick={onConfirm}
            className="flex min-h-11 items-center justify-center gap-2 rounded-xl bg-rose-600 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-rose-200 transition hover:bg-rose-700 active:scale-95"
          >
            <Trash2 size={16} />
