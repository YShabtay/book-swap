        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4 p-5">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <button
              ...
              className="flex min-h-11 items-center justify-center gap-1.5 rounded-xl px-3 py-2.5 text-sm font-semibold text-rose-600 transition hover:bg-rose-50 sm:justify-start"
            >
              <Trash2 size={16} />
              {t('deleteBook')}
            </button>
